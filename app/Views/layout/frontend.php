	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item <?=($menu == 'home'?'active':'')?>"><a href="/" class="nav-link" >Beranda</a></li>
	          <li class="nav-item <?=($menu == 'about'?'active':'')?>"><a href="/about" class="nav-link">Tentang Kami</a></li>
	          <li class="nav-item <?=($menu == 'rent'?'active':'')?>"><a href="/rent" class="nav-link">Kendaraan</a></li>
	          <li class="nav-item <?=($menu == 'contact'?'active':'')?>"><a href="/contact" class="nav-link">Kontak</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
