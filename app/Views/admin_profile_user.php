<?= $this->extend('layout/template_admin_profile') ?>
              ...
              <form action="<?=$action?>" method="POST" enctype="multipart/form-data" novalidate>
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    ...
                    <img src="<?=base_url('assets-admin/img/profile/'.$photoProfile);?>" id="gambar_edit"alt="Profile"/>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="displayname" type="text" class="form-control" id="displayname" value="<?=$displayname?>">
                  </div>
                </div>
                <div class="row mb-3">
